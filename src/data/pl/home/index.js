...
export default {
  ...
  repertoire: {
    ...
    list: [
      'J. Haydn - Kwartet smyczkowy C-dur op.20 nr 2',
      ...
      'F. Lessel – Kwartet smyczkowy B-dur op. 19',
      'F. Schubert – Kwartet smyczkowy Es-dur nr 10 D. 87',
      ...
      'K. Szymanowski – Kwartet smyczkowy op. 37 nr 1',
      ...
      'A. Tansman – Kwartet smyczkowy nr 4',
