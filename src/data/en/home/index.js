...
export default {
  ...
  repertoire: {
    ...
    list: [
      ...
      'W.A. Mozart - String Quartet K. 421 no. 15 [30’]',
      'F. Lessel - String Quartet op. 19 [20’]',
      'L. van Beethoven – String quartet op. 18 nr 4 [25’]',
      'F. Schubert - String Quartet D. 810 no. 14 "Death and the Maiden" [40’]',
      'F. Mendelssohn – String quartet op. 13 nr 2 [30’] ',
      'S. Moniuszko – String quartet  nr 1 [15’]',
      'K. Szymanowski – String quartet op. 56 nr 2 [20’]',
      'K. Szymanowski - String Quartet op. 37 no. 1 [19’]',
